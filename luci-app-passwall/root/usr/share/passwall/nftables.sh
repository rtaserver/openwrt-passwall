...
filter_haproxy() {
	...
	echolog "- [$?]Add load balancing node to nftset[$NFTSET_VPSLIST] direct connection completed"
}
...
del_firewall_rule() {
	...
	$DIR/app.sh echolog "Deletion of nftables firewall rules completed."
}

flush_nftset() {
	$DIR/app.sh echolog "Clear NFTSET."
